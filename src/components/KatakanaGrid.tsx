...
const ROWS = [
  { label: 'Vokale',    ids: ['k-a','k-i','k-u','k-e','k-o'] },
  { label: 'K-Reihe',  ids: ['k-ka','k-ki','k-ku','k-ke','k-ko'] },
  { label: 'S-Reihe',  ids: ['k-sa','k-si','k-su','k-se','k-so'] },
  { label: 'T-Reihe',  ids: ['k-ta','k-ti','k-tu','k-te','k-to'] },
  { label: 'N-Reihe',  ids: ['k-na','k-ni','k-nu','k-ne','k-no'] },
  { label: 'H-Reihe',  ids: ['k-ha','k-hi','k-hu','k-he','k-ho'] },
  { label: 'M-Reihe',  ids: ['k-ma','k-mi','k-mu','k-me','k-mo'] },
  { label: 'Y-Reihe',  ids: ['k-ya','k-yu','k-yo'] },
  { label: 'R-Reihe',  ids: ['k-ra','k-ri','k-ru','k-re','k-ro'] },
  { label: 'W-Reihe',  ids: ['k-wa','k-wi','k-we','k-wo'] },
  { label: 'N (nasal)',ids: ['k-nn'] },
]
...
export default function KatakanaGrid() {
  ...
  const mastered = Object.values(items).filter(i => i.category === 'katakana' && i.status === 'mastered').length
  const total = Object.values(items).filter(i => i.category === 'katakana').length
